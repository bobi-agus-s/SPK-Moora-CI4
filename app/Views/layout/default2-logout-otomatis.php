<?php
    ...
    if(session('start_session')){
        $elapsed_time = time() - session('start_session');
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="<?= site_url('/'); ?>" class="d-flex align-items-center">
                                ...
                                <span style="font-size: 1.5rem;" class="">SPK Moora</span>
                            </a>
                        </div>
        ...
        <div id="main">
            ...
            <div class="page-heading d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3 name">
                        <h5 class="font-bold "><?= userLogin()->nama_lengkap ?> (<?= userLogin()->username ?>)</h5>
                        <h6 class="text-muted mb-0"><?= userLogin()->level ?></h6>
                    </div>
                </div>
            </div>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p><?= date('Y') ?> &copy; Bobi Agus Saputro</p>
                    </div>
                </div>
            </footer>
        </div>
...
<!-- <script src="<?= base_url() ?>/template/assets/js/pages/dashboard.js"></script> -->
    ...
    <!-- logout otomatis saat tidak ada interaksi pengguna -->
    <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>/template/assets/js/jquery.idle.js"></script>
